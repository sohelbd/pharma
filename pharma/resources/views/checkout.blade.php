              ...
              {!! Form::open(array('url' => '/save_order','files'=>true)) !!}
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <thead>
                   ...
                   <tr>
                      <td><input class="text-black" name="productName" value="{{$c->name}}" type=""></td>
                      <td ><input class="text-black" name="qty" value="{{$c->qty}}" type=""></td>
                   </tr>
                      ...
                      <tr>
                        ...
                        <td ><input class="text-black" name="subTotal" value="{{Cart::subtotal()}}" type=""></td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>TAX</strong></td>
                        <td ><input class="text-black" name="tax" value="{{Cart::tax()}}" type=""></td>
                      </tr>
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Total</strong></td>
                        <td ><input class="text-black" name="total" value="{{Cart::total()}}" type=""></td>
                      </tr>
